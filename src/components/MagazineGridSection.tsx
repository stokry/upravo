...
function createSlug(title: string, id: number | string): string {
  return `${title
    ...
    .replace(/^-|-$/g, '')}-${id}`; // Remove leading/trailing hyphens and add ID
}
...
export function MagazineGridSection({ title, articles }: MagazineGridSectionProps) {
              ...
              <div className="aspect-w-16 aspect-h-9">
                <img 
                  ...
                  onError={(e) => {
                    ...
                    target.src = '/placeholder-image.jpg'; // Add a placeholder fallback
                  }}
                />
              </div>
